  ...
  render() {
    ...
    return (
      <div class='about-us'>
        ...
        <div className='about-us__pre-div'>
        ...
        <p>W naszej ofercie znajduje się Yerba Mate jak i akcesoria użytkowe.
          Staramy się trafiać w gusta wszystkich klientów, dlatego oferujemy
          yerba mate w wielu gatunkach.</p>
        <h2>Zaufaj naszemu doświadczeniu i rób zakupy bez ryzyka!</h2>
      </div>
    );
  }
}
